...
void main() {
  ...
  test('title similarity', () {
    var value = StringSimilarity.compareTwoStrings('This is a song title', 'This is a Song Title');
    logger.i('value: $value');

    value = StringSimilarity.compareTwoStrings('Come to Me by Bonnie Raitt', 'Come To Me by Bonnie Raitt');
    logger.i('value: $value');
  });
}
