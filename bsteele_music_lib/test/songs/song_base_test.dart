...
void main() {
  ...
  test('testEquals', () {
    ...
    b = SongBase(
      ...
      artist: 'bob',
      copyright: 'bsteele.com',
      key: music_key.MajorKey.get(music_key.MajorKeyEnum.Ab),
      beatsPerMinute: 100,
      beatsPerBar: 4,
      unitsPerMeasure: 4,
      chords: 'v: A B C D',
...
o: end here''',
  ...
  test('test songBase from constructor', () {
...

    {
      ...
      expect(a.key, music_key.MajorKey.getDefault());
...
''';
  ...
  test('test ChordSectionGridData toString()', () {
    ...
    int bpm = 106;
    {
      ...
      expect(grid.get(0, 0)?.transpose(music_key.MajorKey.C, 0), 'I:');
      expect(grid.get(0, 1)?.transpose(music_key.MajorKey.C, 0), 'A');
      expect(grid.get(0, 2)?.transpose(music_key.MajorKey.C, 0), 'B');
      expect(grid.get(0, 3)?.transpose(music_key.MajorKey.C, 0), 'C');
      expect(grid.get(0, 4)?.transpose(music_key.MajorKey.C, 0), 'D');
      expect(grid.get(0, 5)?.transpose(music_key.MajorKey.C, 0), ']');
      expect(grid.get(0, 6)?.transpose(music_key.MajorKey.C, 0), 'x4');
      expect(grid.get(1, 0)?.transpose(music_key.MajorKey.C, 0), 'V:');
      expect(grid.get(1, 1)?.transpose(music_key.MajorKey.C, 0), 'G');
      expect(grid.get(1, 2)?.transpose(music_key.MajorKey.C, 0), 'G');
      expect(grid.get(1, 3)?.transpose(music_key.MajorKey.C, 0), 'G');
      expect(grid.get(1, 4)?.transpose(music_key.MajorKey.C, 0), 'G');
      expect(grid.get(2, 0)?.transpose(music_key.MajorKey.C, 0), isNull);
      expect(grid.get(2, 1)?.transpose(music_key.MajorKey.C, 0), 'C');
      expect(grid.get(2, 2)?.transpose(music_key.MajorKey.C, 0), 'C');
      expect(grid.get(2, 3)?.transpose(music_key.MajorKey.C, 0), 'G');
      expect(grid.get(2, 4)?.transpose(music_key.MajorKey.C, 0), 'G');
      expect(grid.get(3, 0)?.transpose(music_key.MajorKey.C, 0), 'O:');
      expect(grid.get(3, 1)?.transpose(music_key.MajorKey.C, 0), 'C');
      expect(grid.get(3, 2)?.transpose(music_key.MajorKey.C, 0), 'C');
      expect(grid.get(3, 3)?.transpose(music_key.MajorKey.C, 0), 'G');
      expect(grid.get(3, 4)?.transpose(music_key.MajorKey.C, 0), 'G');
      expect(grid.get(3, 5)?.transpose(music_key.MajorKey.C, 0), '⎤');
      expect(grid.get(4, 0)?.transpose(music_key.MajorKey.C, 0), isNull);
      expect(grid.get(4, 1)?.transpose(music_key.MajorKey.C, 0), 'E');
      expect(grid.get(4, 2)?.transpose(music_key.MajorKey.C, 0), 'F');
      expect(grid.get(4, 3)?.transpose(music_key.MajorKey.C, 0), 'G');
      expect(grid.get(4, 4)?.transpose(music_key.MajorKey.C, 0), 'E');
      expect(grid.get(4, 5)?.transpose(music_key.MajorKey.C, 0), '⎦');
      expect(grid.get(4, 6)?.transpose(music_key.MajorKey.C, 0), 'x3');
      expect(grid.get(5, 0)?.transpose(music_key.MajorKey.C, 0), isNull);
      expect(grid.get(5, 1)?.transpose(music_key.MajorKey.C, 0), 'A');
      expect(grid.get(5, 2)?.transpose(music_key.MajorKey.C, 0), 'B');
      expect(grid.get(5, 3)?.transpose(music_key.MajorKey.C, 0), 'C');
    }
  });
