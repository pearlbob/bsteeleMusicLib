...
void checkMeasureNodesScaleNoteByMeasure(
    ScaleNote scaleNote, List<Measure> measures, int measureN, int chordN) {
  expect(scaleNote, measures[measureN].chords[chordN].scaleChord.scaleNote);
}

void checkMeasureNodesSlashScaleNoteByMeasure(
    ScaleNote scaleNote, List<Measure> measures, int measureN, int chordN) {
...
void main() {
  ...
  test("testChordSectionparseString", () {
...

    {
      //  repeat row
      ChordSection chordSection = ChordSection.parseString(
          "I4:, G D Em7 Cadd9, G D Em7 Cadd9, ", beatsPerBar);
      expect(chordSection, isNotNull);
      logger.d(chordSection.toMarkup());
      expect(
        chordSection.toMarkup(),
    ...
    }
    {
      //  comment only
      ChordSection chordSection =
          ChordSection.parseString("V: (comment) A C#m F#m F#m/E\n", 4);
      expect(chordSection, isNotNull);
    ...
    try {
      ...
      ChordSection chordSection =
          ChordSection.parseString("ia: EDCBA (single notes rapid)", 4);
      logger.i(chordSection.toMarkup());
      expect("V: (ia:) EDCBA (single notes rapid)",
          chordSection.toMarkup().trim());
    } catch (e) {
    ...
    }
    {
      //  infinite loop?
      ChordSection chordSection = ChordSection.parseString(
          "o:AGEDCAGEDCAGA (organ descending scale)", 4);
      expect(chordSection != null, isTrue);
      SectionVersion outro =
...

    {
      ...
      ChordSection chordSection =
          ChordSection.parseString("I: G .G Bm Bm  x2", 4);
      expect(chordSection != null, isTrue);
      logger.d(chordSection.toMarkup());
    ...
    }
    {
      ...
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.A), measures, 0, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.B), measures, 1, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.C), measures, 2, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.D), measures, 3, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.Ab), measures, 4, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.Bb), measures, 4, 1);
      checkMeasureNodesSlashScaleNoteByMeasure(null, measures, 4, 0);
      checkMeasureNodesSlashScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.Gs), measures, 4, 1);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.A), measures, 5, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.Eb), measures, 6, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.C), measures, 7, 0);
    }
    {
      ChordSection chordSection =
          ChordSection.parseString("I: A - - -\n" + "Ab - - G ", 4);
      expect(chordSection != null, isTrue);
      logger.d(chordSection.toMarkup());
      SectionVersion intro =
          SectionVersion.bySection(Section.get(SectionEnum.intro));
      ...
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.A), measures, 0, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.A), measures, 1, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.A), measures, 2, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.A), measures, 3, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.Ab), measures, 4, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.Ab), measures, 5, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.Ab), measures, 6, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.G), measures, 7, 0);
    }
    {
      ChordSection chordSection =
          ChordSection.parseString("I: A - - -\n" + "Ab - - X ", 4);
      ...
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.Ab), measures, 6, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.X), measures, 7, 0);
    ...
    }
    {
      ...
      expect(ScaleNote.get(ScaleNoteEnum.Ab),
          measures[0].chords[0].scaleChord.scaleNote);
      expect(ScaleNote.get(ScaleNoteEnum.Bb),
          measures[0].chords[1].scaleChord.scaleNote);
      expect(ScaleNote.get(ScaleNoteEnum.A),
          measures[1].chords[0].scaleChord.scaleNote);
      expect(ScaleNote.get(ScaleNoteEnum.Eb),
          measures[2].chords[0].scaleChord.scaleNote);
      expect(ScaleNote.get(ScaleNoteEnum.C),
          measures[3].chords[0].scaleChord.scaleNote);
    ...
    }
    {
      ...
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.C), measures, 1, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.A), measures, 2, 0);
      checkMeasureNodesScaleNoteByMeasure(
          ScaleNote.get(ScaleNoteEnum.D), measures, 3, 0);
